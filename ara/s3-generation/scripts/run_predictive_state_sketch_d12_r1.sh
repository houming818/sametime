...
root="ara/s3-generation/evidence/s3_predictive_state_sketch_d12/r1_seed11201"
...
test -f "$warm_start"
test -f /home/nio/datasets/nio/releases/NioClean-ZHEN-S098-7M-v2/pairs.tsv
...
python3 "$runner" \
  --mode pilot --steps 10000 --batch-size 16 --eval-rows 1000 \
  --generation-examples 64 --max-lines 400000 --log-every 250 \
...
sendme -s "D12-R1 predictive-state 10K+10K finished" -f "$root/comparison.json" || true
