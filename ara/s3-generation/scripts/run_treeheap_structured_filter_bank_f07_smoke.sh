...
evidence="ara/s3-generation/evidence/s3_treeheap_structured_filter_bank_f07/smoke_seed11801"
mkdir -p "$evidence"

command=(
  python3 ara/s3-generation/src/s3_treeheap_structured_filter_bank_f07.py
...
sha256sum \
  ...
  ara/s3-generation/logic/treeheap_structured_filter_bank_f07.zh.md \
