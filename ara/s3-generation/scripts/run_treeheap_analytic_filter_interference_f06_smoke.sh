...
evidence="ara/s3-generation/evidence/s3_treeheap_analytic_filter_interference_f06/smoke_r2_seed11701"
mkdir -p "$evidence"

command=(
  python3 ara/s3-generation/src/s3_treeheap_analytic_filter_interference_f06.py
...
sha256sum \
  ...
  ara/s3-generation/logic/treeheap_analytic_filter_interference_f06.zh.md \
