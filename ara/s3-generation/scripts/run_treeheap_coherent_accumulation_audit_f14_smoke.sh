...
evidence="ara/s3-generation/evidence/s3_treeheap_coherent_accumulation_audit_f14/smoke_seed12501"
mkdir -p "$evidence"

command=(
  python3 ara/s3-generation/src/s3_treeheap_coherent_accumulation_audit_f14.py
...
sha256sum \
  ara/s3-generation/src/s3_treeheap_coherent_accumulation_audit_f14.py \
  ara/s3-generation/logic/treeheap_coherent_accumulation_audit_f14.zh.md \
