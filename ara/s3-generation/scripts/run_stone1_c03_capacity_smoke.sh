...
EVIDENCE="$ROOT/ara/s3-generation/evidence/s3_stone1_capacity_rate_distortion_smoke_20260722a"
CODE_COMMIT=d18ec85
...
python3 "$ROOT/ara/s3-generation/src/test_stone1_capacity_rate_distortion.py" \
...
python3 "$ROOT/ara/s3-generation/src/s3_stone1_capacity_rate_distortion.py" \
