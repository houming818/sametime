"""AttnPaths @ 256D: unit_root × mul tree, 31D attention weights, train from scratch"""
...
print(f"Gold init: {gold0:.1f}%  cos init: {cos0:.4f}")
...
print(f"\nTraining: {len(single_ai)} single + {attn_paths.num_paths} paths @ 256D")
EPOCHS = 400
